<?php $__env->startSection('admin_content'); ?>
    ...
    <div class="container">
        <div class="row">
            <form action="<?php echo e(route('configuration.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="site_name" name="site_name"
                                value="<?php echo e(@$configurations['site_name']); ?>">
                        </div>
                        <div class="form-group mb-2">
                            <label for="site_description">Mô tả trang web:</label>
                            <textarea type="text" class="form-control" id="site_description" name="site_description" rows="2"><?php echo e(@$configurations['site_description']); ?></textarea>
                        </div>
                        <div class="form-group mb-2">
                            <label for="site_slogan">Slogan:</label>
                            <input type="text" class="form-control" id="site_slogan" name="site_slogan"
                                value="<?php echo e(@$configurations['site_slogan']); ?>">
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <textarea type="text" class="form-control" id="site_slogan_description" name="site_slogan_description"
                                rows="3"><?php echo e(@$configurations['site_slogan_description']); ?></textarea>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <img id="logo-site" src="<?php echo e(@asset($configurations['logo'])); ?>" alt="Logo"
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="icon_services_firt" name="icon_services_firt"
                                value="<?php echo e(@$configurations['icon_services_firt']); ?>" placeholder="Icon fontawesome">
                        </div>
                        <div class="form-group mb-2">
                            <label for="services_second">Dịch vụ 2:</label>
                            <input type="text" class="form-control" id="services_second" name="services_second"
                                value="<?php echo e(@$configurations['services_second']); ?>">
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <input type="color" class="form-control" id="color_services_second"
                                name="color_services_second" value="<?php echo e(@$configurations['color_services_second']); ?>">
                        </div>
                        <div class="form-group mb-2">
                            <label for="icon_services_second">Icon dịch vụ 2:</label>
                            <input type="text" class="form-control" id="icon_services_second"
                                name="icon_services_second" value="<?php echo e(@$configurations['icon_services_second']); ?>"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="color" class="form-control" id="color_services_fourth"
                                name="color_services_fourth" value="<?php echo e(@$configurations['color_services_fourth']); ?>">
                        </div>
                        <div class="form-group mb-2">
                            <label for="icon_services_fourth">Icon dịch vụ 4:</label>
                            <input type="text" class="form-control" id="icon_services_fourth"
                                name="icon_services_fourth" value="<?php echo e(@$configurations['icon_services_fourth']); ?>"
                                placeholder="Icon fontawesome">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\CuahangGundam\resources\views/admin/configuration/index.blade.php ENDPATH**/ ?>