...
//services
Route::get('/services-orders', [ServiceSiteController::class, 'index'])->name('site.services');
Route::prefix('/services')->group(function(){
    Route::get('/check-out/{id}', [ServiceSiteController::class, 'checkoutPage'])->name('site.service.checkout');
    Route::post('/create/{id}', [ServiceSiteController::class, 'createServiesOrder'])->name('service.create');
    Route::put('/change-status/{id}', [ServiceSiteController::class, 'changeStatusServiceOrder'])->name('service.change.status');
    Route::put('/update/{id}', [ServiceSiteController::class, 'updateServiesOrder'])->name('service.update');
});
...
Route::prefix('/')->middleware('admin.login')->group(function () {
    ...
    Route::prefix('/admin')->group(function () {
        ...
        Route::prefix('/servicer-oders')->group(function () {
            Route::get('/', [ServicesController::class, 'index'])->name('service.orders.index');
            Route::get('/edit/{id}', [ServicesController::class, 'edit'])->name('service.order.edit');
        });
    });
});
