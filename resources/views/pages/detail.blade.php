    ...
    <div class="body" style="padding-top: 50px;">
        ...
        <div class="mt-3 d-md-flex">
            ...
            <div class="col-md-6 my-3">
                ...
                @if(isset($product) && !in_array($product->id_category, [1, 4]))
                    <div class="d-flex">
                ...
                <form action="" method="POST">
                    <div class="d-flex mt-3">
                        <a href="{{ route('site.service.checkout', @$product->id) }}" class="product__cart-buy text-decoration-none" name="buy-now">
                            Đặt lịch
                        </a>
                    </div>
                </form>
