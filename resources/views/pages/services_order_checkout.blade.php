...
@section('content')
<form class="body mt-5" action="{{ route('service.create', ['id' => $product->id]) }}" method="POST" id="service-checkout" enctype="multipart/form-data">
    @csrf
    @php
        $user = Auth::user();
        // dd($product);
            ...
            <div class="col-12 col-md-6">
                <div style="font-size: 16px;">
                    ...
                    <input type="text" name="customer" class="form-control my-1" placeholder="Tên khách hàng"
                        value="{{ @$user->fullname ?? old('customer') }}">
                </div>
    ...
    <h5 class="d-flex justify-content-end align-items-center">
        ...
        <input type="hidden" name="total_funds" value="{{ $product->promotional_price }}">
    </h5>
    <a href="{{ url('/product/detail', $product->id) }}" class="btn btn-danger">
